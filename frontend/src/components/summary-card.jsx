...
export default function SummaryCard({ result, selectedSpecies }) {
  ...
  const handlePrint = () => {
    ...
    // Validator seal stamp (Recruiter Wow)
    ...
    doc.text("Generated by VerdantAI Precision Agriculture Platform. Validated for recruiter demo review.", pageWidth / 2, pageHeight - 20, { align: "center" });
        ...
        {result ? (
          ...
          <div className="text-center py-12 border border-dashed border-white/5 rounded-2xl bg-white/[0.005]">
            ...
            <p className="text-[10px] text-gray-600 max-w-[280px] mx-auto leading-relaxed">
              Complete leaf specimen spectral indexing inside the capture center to generate custom AI clinical treatment checklists.
            </p>
          </div>
        )}
      </CardContent>
